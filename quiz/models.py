	...
	def new_sitting(self, user, quiz):
		...
		if mode == False:
			...
			if len(que_attemps) > 0:
				...
				print("len(que_attemps)",len(que_attemps))
				q1.tempory_questions=len(que_attemps)
				print("q1.total_repeat",q1.total_repeat)
				...
				print("question_set5",question_set)
				...
				print("question_set0",question_set)
				...
				q1.save()
				question_set=question_repeate+question_sets
				print("question_set1",question_set)
				...
				print("question_set3",question_set)
		...
		for q in Question.objects.filter(quiz=self.quiz,id=question_id):
			...
			try:
				...
				if mode == False:
					...
					# 	#self.question_list.delete()
					# 	return Question.objects.get_subclass(id=None)
					# if date_times >= times:
					# 	self.complete = True
					# 	self.end = datetime.datetime.now()
					# 	self.save()										
