    ...
    def new_sitting(self, user, quiz):
        ...
        if modes == True and modess == False:
            ...
            for j in Question.objects.filter(quiz=quiz,is_slide=False):
                session_slidess.append(j.id)
            session_slidess=session_slidess[0:slide_que]
            ...
            if value == "-":
                ...
                q1.session_time=user_date_time
                q1.save()
            ...
            if random_order == True:
                random.shuffle(session_slidess)
            ...
            if len(session_slides) > 0: #repeat_question:
                ...
                print("session_slidess",session_slidess)
                E_question_set=session_slides+session_slidess
                print("repeat E_question_set",E_question_set)
                question_set = E_question_set
            else:
                # q1.total_new_question=max_question
                # q1.save()
                E_question_set=session_slidess
            ...
            if modes == False and modess == False:
                ...
                if len(que_attemps) > 0:
                    q1.total_new_question=new_questions
                    q1.tempory_questions=len(que_attemps)
                    q1.save()
        ...
        modess=mode.exam_mode
        if modes == True and modess == False:
            session_count=q1.session
            q1.session=session_count+1
            q1.save()
...
class Sitting(models.Model):
    ...
    def get_first_question(self):
        ...
        modes=mode.e_learning
        modess=mode.exam_mode
        #is_slides=Question.objects.filter(quiz=self.quiz)
        if modes == True and modess == False:# and is_slides == True:
            
            #self.question_list.pop(0)
            #print("self.question_list",self.question_list)
            #print(type(self.question_list))
            #self.question_list=list(self.question_list.split(","))
            #self.question_list.pop(0)
            self.save()
