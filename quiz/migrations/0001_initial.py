...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attempt_question', models.IntegerField(blank=True, max_length=100, null=True, verbose_name='attemp_questions')),
                ('correct_answer', models.IntegerField(blank=True, max_length=1024, null=True, verbose_name='correct_answer')),
                ...
                ('questions', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='questio', to='quiz.Question', verbose_name='Questio')),
                ('quiz', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='quizes_summary', to='quiz.Quiz', verbose_name='Quiz1')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='UQuestion', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
